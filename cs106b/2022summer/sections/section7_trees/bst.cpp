...
bool isBSTHelper(TreeNode* root, TreeNode* lowerBound, TreeNode* upperBound) {
    ...
    return isBSTHelper(root->left, lowerBound, root)
            && isBSTHelper(root->right, root, upperBound);
}
