/*
 * Functions to compute soundex encoding, and find names sound similar according to the encodings
 */
 ...
 *
 * @s Input string
 * @return A string composed of only English letters
 *
 * Fixed Bugs:
 * 1. A non-letter character at the beginning would never be removed
 * 2. When input string is empty, null character would be returned.
 */
